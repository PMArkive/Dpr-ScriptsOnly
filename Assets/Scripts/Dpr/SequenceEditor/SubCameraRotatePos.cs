...
using static NexPlugin.DataStore;
using System.Collections.Generic;

namespace Dpr.SequenceEditor
{
    [Macro(CommandNo.SubCameraRotatePos, "yellow", "", "")]
	public class SubCameraRotatePos : Macro
	{
		public int angle;
		...
		public SubCameraRotatePos(Macro macro) : base(macro)
        {
