...
{
    [Macro(CommandNo.SubCameraMoveRelativeTrainer, "yellow", "", "")]
	public class SubCameraMoveRelativeTrainer : Macro
	{
		...
		public SubCameraMoveRelativeTrainer(Macro macro) : base(macro)
        {
            trgChara = Parse_SEQ_DEF_TRAINER_ADD(macro.GetValue("trgChara"));
