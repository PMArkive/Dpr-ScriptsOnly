...
{
    [Macro(CommandNo.ParticleFollowPokeNodeName, "green", "one_frame", "")]
	public class ParticleFollowPokeNodeName : Macro
	{
		...
		public bool isRot;
		public bool isScl;
		public bool isAnimRot;
		
		public ParticleFollowPokeNodeName(Macro macro) : base(macro)
        {
            ...
            isAnimRot = ParseBool(macro.GetValue("isAnimRot"), 0);
        }
    }
}