...
namespace Dpr.Battle.Logic
{
    public class BattleViewBase
    {
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.GetCommMode();
        	}
        	return (BtlCommMode)0;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.IsMultiMode();
        	}
        	return false;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  return this.m_pMainModule.IsClientTrainerExist(clientID);
        	}
        	return (ulong)((clientID & 0xff) < 2);
        }

        public virtual bool IsWatchMode()
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.IsWatchMember();
        	}
        	return false;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.GetPlayerFriendCleintID();
        	}
        	return 0;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.GetEnemyClientID(idx);
        	}
        	return 0;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.GetEnemyClientNum(clientID);
        	}
        	return 0;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  return this.m_pMainModule.IsClientNPC(idx);
        	}
        	return (ulong)((idx & 0xff) == 0);
        }

        public virtual BtlvPos GetClientIdToBtlvPos(byte clientId, byte pokeIdx = 0)
        {
        	if (this.m_pMainModule != null) {
        	  var uVar1 = this.m_pMainModule.GetClientPokePos(clientId,pokeIdx);
        	  var uVar2 = this.m_pMainModule.BtlPosToViewPos(uVar1);
        	  return uVar2;
        	}
        	return (ulong)((uint)clientId & 0xff);
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.GetClientTrainerID(clientID);
        	}
        	return 0;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.GetClientTrainerType(clientID);
        	}
        	return 0;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.GetClientTrainerModelID(clientID);
        	}
        	return default;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.GetClientTrainerColorID(clientID);
        	}
        	return 0;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.GetClientTrainerName(clientID);
        	}
        	return default;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.GetClientTrainerNameLabel(clientID);
        	}
        	return default;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.GetClientTrainerSex(clientID);
        	}
        	return (Sex)0;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.IsPlayerRatingDisplay();
        	}
        	return false;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.GetClientRating(clientID);
        	}
        	return 0;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.IsSkyBattle();
        	}
        	return false;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.IsZukanRegistered(bpp);
        	}
        	return false;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  return this.m_pMainModule.m_fWazaEffectEnable != 0;
        	}
        	return false;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.IsItemEnable();
        	}
        	return false;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.GetEnableTimeStop();
        	}
        	return false;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.GetEnableVoiceChat();
        	}
        	return false;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.IsRecordPlayMode();
        	}
        	return false;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  return this.m_pMainModule.GetEscapeMode();
        	}
        	return (BtlEscapeMode)3;
        }

        public virtual bool CanUseEscapeItem()
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.CanUseEscapeItem();
        	}
        	return false;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  return this.m_pMainModule.BtlPosToViewPos(pos);
        	}
        	return (BtlvPos)0xff;
        }
        ...
        {
        	if (this.m_pMainModule != null) {
        	  return this.m_pMainModule.ViewPosToBtlPos(pos);
        	}
        	return (BtlPokePos)5;
        }
        ...
        public virtual ClientPublicInformation GetUiDisplay_GetClientPublicInfomation(in byte clientID)
        {
        	if (this.m_pMainModule != null) {
        ...
        {
        	if (this.m_pMainModule != null) {
        	  this.m_pMainModule.GetSetupStatusFlag(0x100);
        	}
        	return false;
        }
