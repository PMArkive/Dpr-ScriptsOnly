...
namespace Dpr.Battle.Logic
{
    public class BTL_POKEPARAM
    {
        ...
        public byte GetID()
        {
        	return this.m_coreParam.myID;
        }

        public ushort GetMonsNo()
        {
        	return this.m_coreParam[0];
        }
        ...
        {
        	return this.m_coreParam.deadCausePokeID;
        }
        ...
        {
        	return this.m_coreParam.killCount;
        }
        ...
        private void dmgrec_FwdTurn()
        {
        	...
        	this.m_dmgrecTurnPtr = this.m_dmgrecTurnPtr + 1;
        ...
        {
        	return this.m_coreParam.confrontRecCount;
        }
        ...
        public byte GetEffortValue(PowerID powerID)
        {
        	switch(powerID) {
        	case 1:
        	  return this.m_doryokuParam.srcPow;
        	case 2:
        	  return this.m_doryokuParam.srcDef;
        	case 3:
        	  return this.m_doryokuParam.srcSpPow;
        	case 4:
        	  return this.m_doryokuParam.srcSpDef;
        	case 5:
        	  return this.m_doryokuParam.srcAgi;
        	default:
        	  return 0;
        	}
        }
        ...
        public byte GetNativeTalentPower(PowerID powerID)
        {
        	switch(powerID) {
        	case 0:
        	  return this.m_coreParam.native_talent_hp;
        	case 1:
        	  return this.m_coreParam.native_talent_atk;
        	case 2:
        	  return this.m_coreParam.native_talent_def;
        	case 3:
        	  return this.m_coreParam.native_talent_spatk;
        	case 4:
        	  return this.m_coreParam.native_talent_spdef;
        	case 5:
        	  return this.m_coreParam.native_talent_agi;
        	default:
        	  return 0;
        	}
        }
        ...
        public byte GetSickTurnCount(WazaSick sick)
        {
        	if (sick < this.m_coreParam.wazaSickCounter.Length) {
        	  return this.m_coreParam.wazaSickCounter + (int)sick[0];
        	}
        }
        ...
        {
        	return this.m_coreParam.totalTurnCount;
        }
        ...
        {
        	return this.m_appearedTurn;
        }

        public bool TURNFLAG_Get(TurnFlag flagID)
        {
        	var uVar1 = flagID >> 3 & 0xff;
        	if (uVar1 < this.m_turnFlag.Length) {
        	  return (1 << (ulong)(flagID & 7) &
        ...
        {
        	var uVar2 = flagID >> 3 & 0xff;
        	if (uVar2 < this.m_permFlag.Length) {
        	  this.m_permFlag + (ulong)uVar2[0] = this.m_permFlag + (ulong)uVar2[0] | (byte)(1 << (ulong)(flagID & 7));
        	}
        }
        	...
        	if (value < 1) {
        	  if (this.m_criticalRank != 0) {
        	    if (-value < (int)(uint)this.m_criticalRank) {
        	      this.m_criticalRank = this.m_criticalRank + (char)value;
        	      return true;
        	    }
        	    this.m_criticalRank = 0;
        	    return true;
        	  }
        	}
        ...
        public void TURNFLAG_Set(TurnFlag flagID)
        {
        	...
        	if (uVar2 < this.m_turnFlag.Length) {
        	  this.m_turnFlag + (ulong)uVar2[0] = this.m_turnFlag + (ulong)uVar2[0] | (byte)(1 << (ulong)(flagID & 7));
        	}
        }
        ...
        public void CONTFLAG_Set(ContFlag flagID)
        {
        	...
        	if (uVar2 < this.m_contFlag.Length) {
        	  this.m_contFlag + (ulong)uVar2[0] = this.m_contFlag + (ulong)uVar2[0] | (byte)(1 << (ulong)(flagID & 7));
        	}
        }
        ...
        public void CONTFLAG_Clear(ContFlag flagID)
        {
        	var uVar2 = flagID >> 3 & 0xff;
        	if (uVar2 < this.m_contFlag.Length) {
        	  this.m_contFlag + (ulong)uVar2[0] = this.m_contFlag + (ulong)uVar2[0] & ((byte)(1 << (ulong)(flagID & 7)) ^ 0xff);
        	}
        }
        ...
        public void TURNFLAG_ForceOff(TurnFlag flagID)
        {
        	var uVar2 = flagID >> 3 & 0xff;
        	if (uVar2 < this.m_turnFlag.Length) {
        	  this.m_turnFlag + (ulong)uVar2[0] = this.m_turnFlag + (ulong)uVar2[0] & ((byte)(1 << (ulong)(flagID & 7)) ^ 0xff);
        	}
        }
        ...
        {
        	return this.m_coreParam.usedItem;
        }

        public void UpdateWazaProcResult(BtlPokePos actTargetPos, byte actWazaType, bool fActEnable, WazaNo actWaza, WazaNo orgWaza)
        {
        	this.m_prevActWazaID = actWaza;
        	this.m_prevSelectWazaID = orgWaza;
        	this.m_prevTargetPos = actTargetPos;
        	this.m_prevWazaType = actWazaType;
        	if (this.m_prevActWazaID != actWaza) {
        	  this.m_wazaContCounter = fActEnable & 1;
        	}
        	if (fActEnable) {
        	  this.m_wazaContCounter = this.m_wazaContCounter + 1;
        	}
        	this.m_wazaContCounter = 0;
        }
        ...
        public byte WAZADMGREC_GetCount(byte turn_ridx)
        {
        	...
        	if ((uint)this.m_dmgrecTurnPtr - (uint)turn_ridx < this.m_dmgrecCount.Length) {
        	  return this.m_dmgrecCount + (int)(uint)this.m_dmgrecTurnPtr - (uint)turn_ridx[0];
        	}
        }
        ...
        {
        	if (cnt < this.m_counter.Length) {
        	  return this.m_counter + (int)cnt[0];
        	}
        }
        ...
        {
        	return this.m_coreParam.fakeViewTargetPokeId;
        }
        ...
        public bool MIGAWARI_AddDamage(ref ushort damage)
        {
        	...
        	if ((uint)damage <= (uint)this.m_migawariHP && iVar2 != 0) {
        	  this.m_migawariHP = (short)iVar2;
        	  return false;
        	}
        	damage = this.m_migawariHP;
        	this.m_migawariHP = 0;
        	return true;
        }
        ...
        {
        	this.m_combiPokeID = combiPokeID;
        	this.m_combiWazaID = combiUsedWaza;
        }
        ...
        public bool CombiWaza_GetParam(out byte combiPokeID, out WazaNo combiUsedWaza)
        {
        	...
        	combiPokeID = this.m_combiPokeID;
        	combiUsedWaza = this.m_combiWazaID;
        	return true;
        }
        ...
        {
        	this.m_doryokuParam.Length =
        	     this.m_doryokuParam.Length + value;
        	if (10 < this.m_doryokuParam.Length) {
        	  this.m_doryokuParam.Length = 10;
        	}
        ...
        {
        	return this.m_coreParam.gParam.passedTurnCount;
        }
