...
namespace Dpr.Contest
{
	public static class ContestDataConstants
	{
		...
		public static readonly ushort[] CONTEST_DRESS_ID_ARRAY = new ushort[]
		{
            (ushort)ShopBoutiqueChange.DressType.Contest,
            (ushort)ShopBoutiqueChange.DressType.Contest + 100,
        };
		...
		public const float CREATE_TIME_RANGE = 5.0f;
		...
		public const float RECEPTION_COMBO_DURATION = 6.0f;
		public const float POSITION_OFFSET_ON_LAUNCH_WAZA = 100.0f;
		public const int ADD_SCORE_ON_GAUGEMAX = 1;

		public static readonly int[] SKILL_APPEAL_POINT_ARRAY = new int[] { 5, 4, 3, 2, 1 };

		public const int PHOTO_PERSENT = 1000;
		public const uint MAX_REC_ENTRY_CNT = 9999;
		public const uint MAX_REC_WIN_CNT = 9999;
		public const uint MAX_REC_GET_RIBBON_NUM = 65536;
		public const int CONTEST_RANKING_NUMBER = 1;
		public const int GENERATE_TIMING_GRADE_POOL_COUNT = 6;
