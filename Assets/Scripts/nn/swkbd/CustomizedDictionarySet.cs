...
namespace nn.swkbd
{
	public struct CustomizedDictionarySet
	{
		...
		public struct DictionaryInfoArray24 : IList<DictionaryInfo>, ICollection<DictionaryInfo>, IEnumerable<DictionaryInfo>, IEnumerable
		{
            ...
            // TODO
            public bool Contains(DictionaryInfo item) { return default; }
			
			// TODO
			public int IndexOf(DictionaryInfo item) { return default; }
			...
			// TODO
			public bool Remove(DictionaryInfo item) { return default; }
